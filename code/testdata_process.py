...
SIZE = 256
metric_use = 'loss'
vees = 'v10_2_1'# actually v6_5_2_1_1
...
model_fold_0.load_state_dict(torch.load(f"{MODEL_PATH}/fold_{0}_seed_1/best_loss_0.pth",map_location = device))
...
model_fold_1.load_state_dict(torch.load(f"{MODEL_PATH}/fold_{1}_seed_1/best_loss_1.pth",map_location = device))
...
model_fold_2.load_state_dict(torch.load(f"{MODEL_PATH}/fold_{2}_seed_1/best_loss_2.pth",map_location = device))
