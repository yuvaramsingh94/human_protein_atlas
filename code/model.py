...
class HpaModel_1(nn.Module):
    def __init__(self, classes, device, base_model_name, pretrained, features, spe_drop = 0.5, att_drop = 0.5):
        ...
        mean_list = [0.083170892049318, 0.08627143702844145,  0.06582942296076659]
        std_list = [0.13561066140407024, 0.13301454127989584, 0.15651865713966945]
    ...
    def trainable_parameters(self):
        return (list(nn.ModuleList([ self.model]).parameters()), 
